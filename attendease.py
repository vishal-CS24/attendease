...
# ========background image======================
        self.wbg = ImageTk.PhotoImage(
            file="pictures\loginback1.jpg")
        ...
        lbgimg = Image.open("pictures\ATTENDEASE.png")
...
# ============frame for buttons and entry widgets=====================
        # ========usernamelogo========
        userlogo = Image.open("pictures\person1.png")
        ...
        passlogo = Image.open("pictures\padlock.png")
        ...
        # ==========email==================
        self.username = ct.CTkEntry(frame, textvariable=self.var_username, fg_color="#2b1b33",
                                    placeholder_text="Enter your username", width=350, height=45, border_width=2, font=("times new roman", 25))
        self.username.place(x=135, y=130)
        # ========password================
        self.password = ct.CTkEntry(frame, show="*", textvariable=self.var_password, fg_color="#2e1929",
                                    placeholder_text="Enter your Password", width=350, height=45, font=("times new roman", 25))
        self.password.place(x=135, y=185)
        # ===========login button============
        login_btn = ct.CTkButton(frame, command=self.login, text="Login", width=200,
                                 height=40, cursor="hand2", fg_color="#34675f", hover_color="#1f2435")
        login_btn.place(x=70, y=250)
        # ==============Reginter button================
        reg_btn = ct.CTkButton(frame, command=self.registration, text="Register Now",
                               width=200, height=40, cursor="hand2", fg_color="#34675f", hover_color="#1f2435")
        reg_btn.place(x=280, y=250)
        # ===============forget button=================
        fgt_btn = ct.CTkButton(frame, text="Forget Password?", command=self.forgot_password,
                               width=410, height=40, cursor="hand2", fg_color="#34675f", hover_color="#1f2435")
